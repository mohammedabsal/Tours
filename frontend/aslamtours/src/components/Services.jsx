                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-6 flex items-end justify-between gap-4">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={(e) => { e.stopPropagation(); window.location.href = `https://wa.me/90808006831?text=Hi%20I%20am%20interested%20in%20${encodeURIComponent(item.title)}`; }}
              ...
              <div className="mt-6 grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="mt-4 flex gap-3">
                    <a
                      href={`https://wa.me/90808006831?text=Hi%20I%20want%20details%20about%20${encodeURIComponent(selected.title)}`}
